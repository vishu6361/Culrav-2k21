...
<footer>
    <div class="flex" style="justify-content:center;">
        <div>
            <h3 style="margin:25px 0;">CULRAV 2021</h3>
            <h5 style="margin:12px 0;">Motilal Nehru National Institute of Technology Allahabad</h5>
            <h5 style="margin:12px 0;">Prayagraj, Uttar Pradesh - 211004</h5>
        </div>
        <div>
            <hr>
            <h5>culrav2k21@gmail.com</h5>
            <br>
        ...
        <div>
            ...
            <h5>&copy; Culrav 2021, MNNIT all rights reserved.</h5>
        </div>
    </div>
</footer>
