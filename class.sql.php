...
class sql extends config{
    ...
    public function __construct(){
        parent::__construct();
        $this->link = mysqli_connect($this->host,$this->mysql_user,$this->mysql_passwd,$this->mysql_dbName) or die(mysqli_error());
    }
    public function process(){
        $result = mysqli_query($this->link, $this->query) or die(mysqli_error($this->link));
        return $result;
    }
    public function getData($column_name,$table,$field,$value,$field1=1,$value1=1,$field2=1,$value2=1,$field3=1,$value3=1){
        $this->query = "SELECT $column_name FROM $table WHERE $field = '$value' and $field1 = '$value1' and $field2 = '$value2' and $field3 = '$value3'";
        $result = $this->process();
